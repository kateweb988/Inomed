...
document.addEventListener('DOMContentLoaded', function () {
   ...
   $('.a2, .nav__link').click(function (e) {
      e.preventDefault();
      $('#popup-call2').arcticmodal({
      });
   });
   $('.a3, .link').click(function (e) {
      e.preventDefault();
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   const wrapGroups = [
      document.querySelectorAll(".header__wrap_1"),
      document.querySelectorAll(".header__wrap_2"),
      document.querySelectorAll(".header__wrap_3")
   ];
